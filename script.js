...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const vehicleData = {
    turbo: {
      ...
      img: "assets/flota_turbo.jpg?v=2",
      ...
      volume: "25 m³ de volumen útil con carpa",
    ...
    sencillo: {
      ...
      img: "assets/flota_sencillo.jpg?v=2",
      ...
      volume: "40 m³ de volumen útil con carpa",
    ...
    dobletroque: {
      ...
      img: "assets/flota_dobletroque.jpg?v=2",
      config: "C3",
      ...
      volume: "50 m³ de volumen útil con carpa",
    ...
    patineta: {
      ...
      img: "assets/flota_patineta.jpg?v=2",
      ...
      volume: "60 m³ de volumen útil con carpa",
    ...
    tractomula: {
      ...
      img: "assets/flota_tractomula.jpg?v=2",
      ...
      volume: "75 m³ de volumen útil con carpa",
